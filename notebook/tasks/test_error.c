...
FOSSIL_TEST_GROUP(c_error_tests) {
    FOSSIL_ADD_TEST(c_error_challenges, c_test_error_print_what);
    FOSSIL_ADD_TEST(c_error_challenges, c_test_error_report_with_format);
    FOSSIL_ADD_TEST(c_error_challenges, c_test_error_switch_handling);
    FOSSIL_ADD_TEST(c_error_challenges, c_test_error_return_code_function);
    FOSSIL_ADD_TEST(c_error_challenges, c_test_error_log_multiple);
    FOSSIL_ADD_TEST(c_error_challenges, c_test_error_custom);
    FOSSIL_ADD_TEST(c_error_challenges, c_test_error_recovery);
    FOSSIL_ADD_TEST(c_error_challenges, c_test_error_network_or_hardware);
    FOSSIL_ADD_TEST(c_error_challenges, c_test_error_security_incident);
    FOSSIL_ADD_TEST(c_error_challenges, c_test_error_ti_model_failure);

    FOSSIL_ADD_SUITE(c_error_challenges);
}
